...
export default function Contact() {
  ...
  return (
    ...
    >
        ...
        <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-4">
              {socialHandles.map((social, index) => (
                <motion.a
                  ...
                  className="group flex items-center justify-between p-5 bg-white rounded-2xl border border-gray-200 hover:border-teal-300 hover:shadow-lg transition-all duration-300"
                >
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-full bg-teal-50 flex items-center justify-center text-teal-600 group-hover:bg-teal-600 group-hover:text-white transition-all">
          ...
          >
            ...
            <div className="space-y-4">
              {coreContacts.map((contact, index) => (
                <motion.div
                  ...
                  animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
                  transition={{ duration: 0.5, delay: 0.3 + index * 0.1 }}
                  className="group p-5 bg-white rounded-2xl border border-gray-200 hover:border-teal-300 hover:shadow-lg transition-all duration-300"
                >
                  <div className="flex items-start justify-between">
                    <div>
                      <div className="inline-block px-3 py-1 bg-yellow-100 text-yellow-700 rounded-full text-xs font-medium mb-2">
                        {contact.role}
                      </div>
                      ...
                      <a
                        ...
                        className="text-sm text-teal-600 hover:text-teal-700 flex items-center gap-1 group/email"
                      >
            ...
            <motion.div
              ...
              className="mt-8 p-6 bg-teal-50 rounded-2xl border border-teal-100"
            >
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-teal-100 rounded-full blur-3xl opacity-20 translate-x-1/2 -translate-y-1/2" />
